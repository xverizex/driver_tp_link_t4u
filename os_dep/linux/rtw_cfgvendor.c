...
#if 0
static int rtw_cmd_doit_raw_data(struct wiphy *wiphy,
	struct wireless_dev *wdev, const void *data, int len)
{
	return 0; 
}

static int rtw_cmd_dumpit_raw_data(struct wiphy *wiphy,
	struct wireless_dev *wdev, struct sk_buf *sk_buf, const void *data, int len, long unsigned int *)
{
	return 0;
}
#endif
